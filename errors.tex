...
\end{equation}
donde $a \leq \xi \leq a + h$, luego
\begin{equation}
  f^{\prime}(a) = \frac{f(a + h) - f(a)}{h} - \frac{1}{2!}f^{\prime \prime}(\xi)h^{2}
\end{equation}

Aquí, hemos obtenido una expresión finíta para la derivada de una función evaluada en un punto, denominada \textit{derivada adelantada}. 
