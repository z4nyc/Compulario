...
\begin{equation}\label{Taylor_newton_met}
0 \approx f(x) + (x-x_0) \cdot f'(x)
\end{equation}
...
Notar que a diferencia del método de la bisección, aquí se hace uso de la derivada, la cual es útil para determinar con mayor rapidez el cero con respecto a la tolerncia establecida, dando así un método eficiente y que hace uso de menores iteraciones con respecto a la bisección.
